...
import _e, { forwardRef as zi, useRef as _t, useState as Li, useMemo as ln, useEffect as un, useImperativeHandle as Ni } from "react";
...
const fn = (u) => {
  ...
  let E = [], C = [], M = [];
  if (!l || l.length === 0)
    return { series: E, labels: C, categories: M };
  const g = l[0], I = Object.keys(g).filter(
    (w) => typeof g[w] == "number"
  ), j = Object.keys(g).find(
    (w) => typeof g[w] == "string"
  );
  switch (f) {
    case "circular":
      ...
      break;
    case "category":
      M = l.map((w) => w.x ?? w.category ?? w.stage ?? w[j]), I.length > 1 ? E = I.map((w) => ({
        name: w,
        data: l.map((P) => P[w])
      })) : E = [{
        name: I[0] || "Series 1",
...
function yn() {
  ...
  function C() {
    try {
      ...
      var j = Object.getOwnPropertyNames(g).map(function(P) {
        return g[P];
      });
  ...
  return dr = C() ? Object.assign : function(M, g) {
    for (var I, j = E(M), w, P = 1; P < arguments.length; P++) {
      I = Object(arguments[P]);
      for (var ee in I)
        l.call(I, ee) && (j[ee] = I[ee]);
      if (u) {
        w = u(I);
        for (var B = 0; B < w.length; B++)
          f.call(I, w[B]) && (j[w[B]] = I[w[B]]);
      }
    }
    return j;
  }, dr;
...
function Ui() {
  ...
  var E = 60106, C = 60107, M = 60108, g = 60114, I = 60109, j = 60110, w = 60112, P = 60113, ee = 60120, B = 60115, Y = 60116, ne = 60121, T = 60117, ve = 60119, ue = 60129, ce = 60131;
  if (typeof Symbol == "function" && Symbol.for) {
    var z = Symbol.for;
    E = z("react.portal"), C = z("react.fragment"), M = z("react.strict_mode"), g = z("react.profiler"), I = z("react.provider"), j = z("react.context"), w = z("react.forward_ref"), P = z("react.suspense"), ee = z("react.suspense_list"), B = z("react.memo"), Y = z("react.lazy"), ne = z("react.block"), T = z("react.fundamental"), ve = z("react.scope"), ue = z("react.debug_trace_mode"), ce = z("react.legacy_hidden");
  }
  function ge(r) {
    if (r == null)
      return null;
  ...
  for (var U = new Uint16Array(16), Oe = 0; 15 > Oe; Oe++)
    U[Oe] = Oe + 1;
  U[15] = 0;
  var X = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, Xe = Object.prototype.hasOwnProperty, ye = {}, je = {};
  function ze(r) {
    return Xe.call(je, r) ? !0 : Xe.call(ye, r) ? !1 : X.test(r) ? je[r] = !0 : (ye[r] = !0, !1);
  }
  function Ge(r, a, i, d) {
    if (i !== null && i.type === 0)
      return !1;
  ...
  var ot = typeof Object.is == "function" ? Object.is : xt, ie = null, Pe = null, A = null, Ne = !1, Ke = !1, Re = null, Ae = 0;
  function Ie() {
    if (ie === null)
      throw Error(f(321));
    return ie;
  ...
  function We() {
    return A === null ? Pe === null ? (Ne = !1, Pe = A = wt()) : (Ne = !0, A = Pe) : A.next === null ? (Ne = !1, A = A.next = wt()) : (Ne = !0, A = A.next), A;
  }
  function Ft(r, a, i, d) {
    for (; Ke; )
  ...
  function St(r, a) {
    if (ie = Ie(), A = We(), a = a === void 0 ? null : a, A !== null) {
  ...
  var Ot = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 }, ut = u({ menuitem: !0 }, Ot), fe = {
  ...
  var He = /([A-Z])/g, ct = /^ms-/, we = l.Children.toArray, ft = $e.ReactCurrentDispatcher, jt = { listing: !0, pre: !0, textarea: !0 }, Je = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/, zt = {}, It = {};
  function Lt(r) {
    if (r == null)
      return r;
    var a = "";
  ...
  var Nt = Object.prototype.hasOwnProperty, Wt = { children: null, dangerouslySetInnerHTML: null, suppressContentEditableWarning: null, suppressHydrationWarning: null };
  function Ct(r, a) {
    if (r === void 0)
  ...
  function Jt(r, a, i) {
    function d(y, S) {
      var m = S.prototype && S.prototype.isReactComponent, Q = L(S, a, i, m), G = [], J = !1, W = { isMounted: function() {
        return !1;
      }, enqueueForceUpdate: function() {
        if (G === null)
          return null;
      }, enqueueReplaceState: function(Tt, _) {
        J = !0, G = [_];
      }, enqueueSetState: function(Tt, _) {
        if (G === null)
          return null;
        G.push(_);
      } };
      if (m) {
        if (m = new S(y.props, Q, W), typeof S.getDerivedStateFromProps == "function") {
        ...
        Q,
        W
      ), m = Ft(S, y.props, m, Q), m == null || m.render == null) {
        r = m, Ct(r, S);
        return;
      }
      if (m.props = y.props, m.context = Q, m.updater = W, W = m.state, W === void 0 && (m.state = W = null), typeof m.UNSAFE_componentWillMount == "function" || typeof m.componentWillMount == "function")
        if (typeof m.componentWillMount == "function" && typeof S.getDerivedStateFromProps != "function" && m.componentWillMount(), typeof m.UNSAFE_componentWillMount == "function" && typeof S.getDerivedStateFromProps != "function" && m.UNSAFE_componentWillMount(), G.length) {
          ...
          if (G = null, J = !1, Z && W.length === 1)
            ...
            for (Z = Z ? 1 : 0; Z < W.length; Z++) {
              var oe = W[Z];
              oe = typeof oe == "function" ? oe.call(m, D, y.props, Q) : oe, oe != null && (Ce ? (Ce = !1, D = u({}, D, oe)) : u(D, oe));
            }
            m.state = D;
          }
        } else
          G = null;
      if (r = m.render(), Ct(r, S), typeof m.getChildContext == "function" && (y = S.childContextTypes, typeof y == "object")) {
  ...
  var dt = function() {
    ...
    return a.destroy = function() {
          ...
          if (y || m.childIndex >= m.children.length) {
            ...
            if (Q !== "" && (this.previousWasTextNode = !1), this.stack.pop(), m.type === "select")
              ...
              if (y) {
                ...
                if (!J)
                  throw Error(f(303));
                this.stack.push(J), b[this.suspenseDepth] += "<!--$!-->";
                continue;
              } else
                b[this.suspenseDepth] += G;
            }
            b[this.suspenseDepth] += Q;
          } else {
            var W = m.children[m.childIndex++], D = "";
            try {
              D += this.render(W, m.context, m.domNamespace);
            } catch (Z) {
              throw Z != null && typeof Z.then == "function" ? Error(f(294)) : Z;
            } finally {
            }
      ...
      S = y, m = this.makeStaticMarkup, Q = this.stack.length === 1, G = "<" + i.type;
      e:
        if (b.indexOf("-") === -1)
            ...
            if (_ === "style") {
              ...
              for (D in W)
                if (W.hasOwnProperty(D)) {
                  var oe = D.indexOf("--") === 0, ae = W[D];
                  if (ae != null) {
                    if (oe)
                      var de = D;
                    else if (de = D, It.hasOwnProperty(de))
                      de = It[de];
                    else {
                      var Tt = de.replace(He, "-$1").toLowerCase().replace(ct, "-ms-");
                      de = It[de] = Tt;
                    }
                    Z += Ce + de + ":", Ce = D, oe = ae == null || typeof ae == "boolean" || ae === "" ? "" : oe || typeof ae != "number" || ae === 0 || fe.hasOwnProperty(Ce) && fe[Ce] ? ("" + ae).trim() : ae + "px", Z += oe, Ce = ";";
                  }
                }
              W = Z || null;
            }
            D = null, J ? Wt.hasOwnProperty(_) || (D = _, D = ze(D) && W != null ? D + '="' + (xe(W) + '"') : "") : D = bt(_, W), D && (G += " " + D);
          }
        }
      m || Q && (G += ' data-reactroot=""');
      var _ = G;
      S = "", Ot.hasOwnProperty(b) ? _ += "/>" : (_ += ">", S = "</" + i.type + ">");
      e: {
...
` && (_ += `
`), _ += m) : y = we(y.children), i = i.type, k = k == null || k === "http://www.w3.org/1999/xhtml" ? Qt(i) : k === "http://www.w3.org/2000/svg" && i === "foreignObject" ? "http://www.w3.org/1999/xhtml" : k, this.stack.push({ domNamespace: k, type: b, children: y, childIndex: 0, context: d, footer: S }), this.previousWasTextNode = !1, _;
    }, r;
  }();
...
function Vi() {
  return vn || (vn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var j = 60106, w = 60107, P = 60108, ee = 60114, B = 60109, Y = 60110, ne = 60112, T = 60113, ve = 60120, ue = 60115, ce = 60116, z = 60121, ge = 60117, $e = 60119, Fe = 60129, me = 60131;
    if (typeof Symbol == "function" && Symbol.for) {
      var L = Symbol.for;
      L("react.element"), j = L("react.portal"), w = L("react.fragment"), P = L("react.strict_mode"), ee = L("react.profiler"), B = L("react.provider"), Y = L("react.context"), ne = L("react.forward_ref"), T = L("react.suspense"), ve = L("react.suspense_list"), ue = L("react.memo"), ce = L("react.lazy"), z = L("react.block"), L("react.server.block"), ge = L("react.fundamental"), $e = L("react.scope"), L("react.opaque.id"), Fe = L("react.debug_trace_mode"), L("react.offscreen"), me = L("react.legacy_hidden");
    }
    function U(e, t, n) {
...
` + xt + e;
    ...
    function Ne(e, t) {
      ...
      var h;
      h = bt.current, bt.current = null, it();
      try {
        if (t) {
          var c = function() {
            throw Error();
...
` + v[O].replace(" at new ", " at ");
        ...
        ie = !1, bt.current = h, xe(), Error.prepareStackTrace = s;
      }
    ...
    var Ie = {}, wt = C.ReactDebugCurrentFrame;
    function We(e) {
      if (e) {
    ...
    function Ft(e, t, n, o, s) {
      {
        ...
        for (var c in e)
          if (h(e, c)) {
            ...
            v && !(v instanceof Error) && (We(s), g("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", o || "React class", n, c, typeof v), We(null)), v instanceof Error && !(v.message in Ie) && (Ie[v.message] = !0, We(s), g("Failed %s type: %s", n, v.message), We(null));
          }
      }
    }
    var at;
    ...
    function Et(e, t, n, o) {
      if (o) {
        ...
        var p = kt(e, t);
        return e.contextTypes && St(e.contextTypes, p, "context"), p;
      }
    }
    ...
    var ut = 0, fe = 1, Rt = 2, He = 3, ct = 4, we = 5, ft = 6, jt = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", Je = jt + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", zt = "data-reactroot", It = new RegExp("^[" + jt + "][" + Je + "]*$"), Lt = Object.prototype.hasOwnProperty, Nt = {}, Wt = {};
    function Ct(e) {
      return Lt.call(Wt, e) ? !0 : Lt.call(Nt, e) ? !1 : It.test(e) ? (Wt[e] = !0, !0) : (Nt[e] = !0, g("Invalid attribute name: `%s`", e), !1);
    }
    function Jt(e, t, n) {
    ...
    function i(e, t, n, o, s, h, c) {
      this.acceptsBooleans = t === Rt || t === He || t === ct, this.attributeName = o, this.attributeNamespace = s, this.mustUseProperty = n, this.propertyName = e, this.type = t, this.sanitizeURL = h, this.removeEmptyString = c;
    }
    var d = {}, k = [
      "children",
    ...
    var m = /^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*\:/i, Q = !1;
    function G(e) {
      !Q && m.test(e) && (Q = !0, g("A future version of React will block javascript: URLs as a security precaution. Use event handlers instead if you can. If you need to generate unsafe HTML try using dangerouslySetInnerHTML instead. React was passed %s.", JSON.stringify(e)));
    }
    var J = /["'&<>]/;
    function W(e) {
      var t = "" + e, n = J.exec(t);
    ...
    function oe(e, t) {
      ...
      if (n !== null) {
        ...
        return s === He || s === ct && t === !0 ? o + '=""' : (n.sanitizeURL && (t = "" + t, G(t)), o + "=" + Z(t));
      } else if (Ct(e))
        return e + "=" + Z(t);
      return "";
    }
    ...
    var Tt = typeof Object.is == "function" ? Object.is : de, _ = null, Ht = null, F = null, Dt = !1, Ut = !1, Ue = null, Vt = 0, wn = 25, Te = !1, pt;
    function et() {
      if (_ === null)
...
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`);
      return Te && g("Do not call Hooks inside useEffect(...), useMemo(...), or other built-in Hooks. You can only call Hooks at the top level of your React function. For more information, see https://reactjs.org/link/rules-of-hooks"), _;
    }
    function kn(e, t) {
      if (t === null)
...
Incoming: %s`, pt, "[" + e.join(", ") + "]", "[" + t.join(", ") + "]");
    ...
    function er() {
      return F === null ? Ht === null ? (Dt = !1, Ht = F = hr()) : (Dt = !0, F = Ht) : F.next === null ? (Dt = !1, F = F.next = hr()) : (Dt = !0, F = F.next), F;
    }
    function vr(e) {
      _ = e, Te = !1;
    }
    function gr(e, t, n, o) {
      for (; Ut; )
        Ut = !1, Vt += 1, F = null, n = e(t, o);
      return mr(), n;
    }
    function mr() {
      Te = !1, _ = null, Ut = !1, Ht = null, Vt = 0, Ue = null, F = null;
    }
    function Sn(e, t) {
      var n = ht.threadID;
    ...
    function yr(e, t, n) {
      if (e !== tr && (pt = "useReducer"), _ = et(), F = er(), Dt) {
        ...
        Te = !0;
        var O;
        e === tr ? O = typeof t == "function" ? t() : t : O = n !== void 0 ? n(t) : t, Te = !1, F.memoizedState = O;
        var R = F.queue = {
          last: null,
          dispatch: null
        }, $ = R.dispatch = Cn.bind(null, _, R);
    ...
    function br(e, t) {
      ...
      Te = !0;
      var h = e();
      return Te = !1, F.memoizedState = [h, n], h;
    }
    function Rn(e) {
      _ = et(), F = er();
    ...
    var _n = {
      ...
      useMutableSource: Dn
    }, qt = "http://www.w3.org/1999/xhtml", wr = "http://www.w3.org/1998/Math/MathML", nr = "http://www.w3.org/2000/svg", ir = {
      html: qt,
      mathml: wr,
      svg: nr
    };
    ...
    function Fn(e, t) {
      return e == null || e === qt ? kr(t) : e === nr && t === "foreignObject" ? qt : e;
    }
    var jn = {
      button: !0,
      checkbox: !0,
    ...
    {
      var Yn = /^(?:webkit|moz|o)[A-Z]/, $n = /^-ms-/, Xn = /-(.)/g, Or = /;\s*$/, vt = {}, sr = {}, Rr = !1, Ir = !1, Gn = function(e) {
        return e.replace(Xn, function(t, n) {
        ...
        sr.hasOwnProperty(t) && sr[t] || (sr[t] = !0, g(`Style property values shouldn't contain a semicolon. Try "%s: %s" instead.`, e, t.replace(Or, "")));
      }, Jn = function(e, t) {
        Rr || (Rr = !0, g("`NaN` is an invalid value for the `%s` css style property.", e));
      }, ei = function(e, t) {
        Ir || (Ir = !0, g("`Infinity` is an invalid value for the `%s` css style property.", e));
      };
      Er = function(e, t) {
    ...
    var ti = Er, Cr = {
      ...
      "aria-rowspan": 0,
      "aria-setsize": 0
    }, gt = {}, ri = new RegExp("^(aria)-[" + Je + "]*$"), ni = new RegExp("^(aria)[A-Z][" + Je + "]*$"), ii = Object.prototype.hasOwnProperty;
    function oi(e, t) {
      {
        if (ii.call(gt, t) && gt[t])
          return !0;
        if (ni.test(t)) {
    ...
    function li(e, t) {
      {
        if (e !== "input" && e !== "textarea" && e !== "select")
          return;
        t != null && t.value === null && !Tr && (Tr = !0, e === "select" && t.multiple ? g("`value` prop on `%s` should not be null. Consider using an empty array when `multiple` is set to `true` to clear the component or `undefined` for uncontrolled components.", e) : g("`value` prop on `%s` should not be null. Consider using an empty string to clear the component or `undefined` for uncontrolled components.", e));
      }
    }
    var Dr = {
      // HTML
    ...
    {
      var te = {}, ui = Object.prototype.hasOwnProperty, Ar = /^on./, ci = /^on[^A-Z]/, fi = new RegExp("^(aria)-[" + Je + "]*$"), di = new RegExp("^(aria)[A-Z][" + Je + "]*$");
      Pr = function(e, t, n, o) {
        if (ui.call(te, t) && te[t])
          return !0;
        var s = t.toLowerCase();
        ...
        if (o != null) {
          ...
          return ci.test(t) && g("Invalid event handler property `%s`. React events use the camelCase naming convention, for example `onClick`.", t), te[t] = !0, !0;
    ...
    var Ve = u.Children.toArray, Me = [], lr = C.ReactCurrentDispatcher, Bt, ur = null, Mr = function() {
      return "";
    }, _r = function(e) {
      return "";
    }, Fr = function(e, t) {
    ...
    Bt = C.ReactDebugCurrentFrame, Fr = function(e, t) {
      si(e, t), li(e, t), hi(e, t, null);
    }, _r = function(e) {
      return Ae(e.type, e._source, null);
    }, jr = function(e) {
      Me.push(e), Me.length === 1 && (ur = Bt.getCurrentStack, Bt.getCurrentStack = Mr);
    }, zr = function(e) {
    ...
    var Wr = !1, Hr = !1, Ur = !1, Vr = !1, qr = !1, Br = {}, Yr = {}, $r = {}, Xr = {}, Gr = {}, Zr = {}, Kr = ["value", "defaultValue"], vi = {
      listing: !0,
      pre: !0,
      textarea: !0
    ...
    function bi(e) {
      ...
      for (var o in e)
        if (e.hasOwnProperty(o)) {
          ...
          s || ti(o, h), h != null && (t += n + (s ? o : yi(o)) + ":", t += Un(o, h, s), n = ";");
        }
      return t || null;
    }
    function Jr(e, t) {
...
Please check the code for the %s component.`, t, t, o), Br[s] = !0;
    ...
    function Si(e) {
      ...
      return u.Children.forEach(e, function(n) {
        n != null && (t += n, !qr && typeof n != "string" && typeof n != "number" && (qr = !0, g("Only strings and numbers are supported as <option> children.")));
      }), t;
    }
    var Ei = Object.prototype.hasOwnProperty, Oi = "style", Ri = {
      children: null,
      dangerouslySetInnerHTML: null,
      suppressContentEditableWarning: null,
      suppressHydrationWarning: null
    };
    function Ii(e, t, n, o, s, h) {
      var c = "<" + e, v = ar(t, n);
      for (var p in n)
        if (Ei.call(n, p)) {
          var O = n[p];
          if (O != null) {
            p === Oi && (O = bi(O));
            var R = null;
            v ? Ri.hasOwnProperty(p) || (R = ae(p, O)) : R = oe(p, O), R && (c += " " + R);
          }
        }
      return s || h && (c += " " + Ce()), c;
    }
    ...
    function Ci(e, t, n) {
      ...
      function h(c, v) {
        var p = xi(v), O = Et(v, t, n, p), R = [], $ = !1, K = {
          isMounted: function(Ye) {
            return !1;
          },
          enqueueForceUpdate: function(Ye) {
            if (R === null)
              return Jr(Ye, "forceUpdate"), null;
          },
        ...
        if (p) {
          if (x = new v(c.props, O, K), typeof v.getDerivedStateFromProps == "function") {
            if (x.state === null || x.state === void 0) {
              var H = X(v) || "Unknown";
              Zr[H] || (g("`%s` uses `getDerivedStateFromProps` but its initial state is %s. This is not recommended. Instead, define the initial state by assigning an object to `this.state` in the constructor of `%s`. This ensures that `getDerivedStateFromProps` arguments have a consistent shape.", H, x.state === null ? "null" : "undefined", H), Zr[H] = !0);
            }
            var re = v.getDerivedStateFromProps.call(null, c.props, x.state);
            if (re === void 0) {
              var se = X(v) || "Unknown";
              Gr[se] || (g("%s.getDerivedStateFromProps(): A valid state object (or null) must be returned. You have returned undefined.", se), Gr[se] = !0);
            }
          ...
          if (v.prototype && typeof v.prototype.render == "function") {
            var le = X(v) || "Unknown";
            Yr[le] || (g("The <%s /> component appears to have a render method, but doesn't extend React.Component. This is likely to cause errors. Change %s to extend React.Component instead.", le, le), Yr[le] = !0);
          }
          var qe = {};
          if (vr(qe), x = v(c.props, O, K), x = gr(v, c.props, x, O), x != null && x.render != null) {
            var pe = X(v) || "Unknown";
            $r[pe] || (g("The <%s /> component appears to be a function component that returns a class instance. Change %s to a class that extends React.Component instead. If you can't use a class try assigning the prototype on the function as a workaround. `%s.prototype = React.Component.prototype`. Don't use an arrow function since it cannot be called with `new` by React.", pe, pe, pe), $r[pe] = !0);
          }
...
Please update the following components: %s`,
          ...
          if (typeof x.UNSAFE_componentWillMount == "function" && typeof v.getDerivedStateFromProps != "function" && x.UNSAFE_componentWillMount(), R.length) {
            var he = R, Se = $;
            if (R = null, $ = !1, Se && he.length === 1)
              x.state = he[0];
            else {
              for (var De = Se ? he[0] : x.state, Yt = !0, mt = Se ? 1 : 0; mt < he.length; mt++) {
                var Ee = he[mt], At = typeof Ee == "function" ? Ee.call(x, De, c.props, O) : Ee;
                At != null && (Yt ? (Yt = !1, De = l({}, De, At)) : l(De, At));
              }
              x.state = De;
            }
          } else
        ...
        var tt;
        {
          if (typeof x.getChildContext == "function") {
            ...
            if (typeof $t == "object") {
              ...
              for (var Xt in tt)
                if (!(Xt in $t))
                  throw Error((X(v) || "Unknown") + '.getChildContext(): key "' + Xt + '" is not defined in childContextTypes.');
            } else
              g("%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().", X(v) || "Unknown");
          }
          tt && (t = l({}, t, tt));
        }
      }
    ...
    var tn = /* @__PURE__ */ function() {
      ...
      return t.destroy = function() {
          ...
          for (var c = [""], v = !1; c[0].length < o; ) {
            ...
            if (v || p.childIndex >= p.children.length) {
              ...
              if (O !== "" && (this.previousWasTextNode = !1), this.stack.pop(), p.type === "select")
                this.currentSelectValue = null;
              else if (p.type != null && p.type.type != null && p.type.type.$$typeof === B) {
                var R = p.type;
                this.popProvider(R);
              } else if (p.type === T) {
                this.suspenseDepth--;
            ...
            var x = p.children[p.childIndex++], H = "";
            jr(this.stack), p.debugElementStack.length = 0;
            try {
              H += this.render(x, p.context, p.domNamespace);
            } catch (re) {
        ...
        if (typeof o == "string" || typeof o == "number") {
          ...
          var v, p = Ci(o, s, this.threadID);
          if (v = p.child, s = p.context, v === null || v === !1)
            return "";
          if (!u.isValidElement(v)) {
            if (v != null && v.$$typeof != null) {
              var O = v.$$typeof;
              throw Error(O === j ? "Portals are not currently supported by the server renderer. Render them conditionally so that they only appear on the client render." : "Unknown element-like object type: " + O.toString() + ". This is likely a bug in React. Please file an issue.");
            }
            var R = Ve(v), $ = {
              type: null,
              domNamespace: h,
          ...
          if (typeof x == "object" && x !== null)
            switch (x.$$typeof) {
              case ne: {
                var se = v, le, qe = {};
                vr(qe), le = x.render(se.props, se.ref), le = gr(x.render, se.props, le, se.ref), le = Ve(le);
                var pe = {
                  type: null,
                  domNamespace: h,
                  children: le,
              ...
              case Y: {
                var Ee = v.type;
                Ee._context === void 0 ? Ee !== Ee.Consumer && (Nr || (Nr = !0, g("Rendering <Context> directly is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?"))) : Ee = Ee._context;
                var At = v.props, tt = this.threadID;
                Qe(Ee, tt);
                var $t = Ee[tt], Xt = Ve(At.children($t)), Ye = {
                  type: v,
                  domNamespace: h,
                  children: Xt,
                  childIndex: 0,
              ...
              case ce: {
                var yt = v, rn = v.type, Mi = rn._payload, _i = rn._init, Fi = _i(Mi), ji = [u.createElement(Fi, l({
                  ref: yt.ref
                }, yt.props))], nn = {
                  type: null,
                  domNamespace: h,
...
Check the render method of \`` + an + "`.");
        ...
        h === ir.html && (v = kr(c)), v === ir.html && c !== o.type && g("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", o.type), mi(c);
        var p = o.props;
        if (c === "input")
          or("input", p), p.checked !== void 0 && p.defaultChecked !== void 0 && !Hr && (g("%s contains an input of type %s with both checked and defaultChecked props. Input elements must be either controlled or uncontrolled (specify either the checked prop, or the defaultChecked prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", p.type), Hr = !0), p.value !== void 0 && p.defaultValue !== void 0 && !Wr && (g("%s contains an input of type %s with both value and defaultValue props. Input elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", p.type), Wr = !0), p = l({
            type: void 0
          }, p, {
          ...
          or("textarea", p), p.value !== void 0 && p.defaultValue !== void 0 && !Vr && (g("Textarea elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled textarea and remove one of these props. More info: https://reactjs.org/link/controlled-components"), Vr = !0);
          var O = p.value;
          if (O == null) {
            var R = p.defaultValue, $ = p.children;
            if ($ != null) {
        ...
        } else if (c === "select") {
          {
            ...
            for (var K = 0; K < Kr.length; K++) {
              var x = Kr[K];
              if (p[x] != null) {
                var H = Array.isArray(p[x]);
                p.multiple && !H ? g("The `%s` prop supplied to <select> must be an array if `multiple` is true.", x) : !p.multiple && H && g("The `%s` prop supplied to <select> must be a scalar value if `multiple` is false.", x);
              }
            }
            p.value !== void 0 && p.defaultValue !== void 0 && !Ur && (g("Select elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled select element and remove one of these props. More info: https://reactjs.org/link/controlled-components"), Ur = !0);
          }
          this.currentSelectValue = p.value != null ? p.value : p.defaultValue, p = l({}, p, {
            value: void 0
          });
        } else if (c === "option") {
          var re = null, se = this.currentSelectValue, le = Si(p.children);
          if (se != null) {
            var qe;
        ...
        Fr(c, p), Nn(c, p);
        var ke = Ii(o.type, c, p, v, this.makeStaticMarkup, this.stack.length === 1), Be = "";
        Sr.hasOwnProperty(c) ? ke += "/>" : (ke += ">", Be = "</" + o.type + ">");
        var he, Se = wi(p);
        Se != null ? (he = [], vi.hasOwnProperty(c) && Se.charAt(0) === `
` && (ke += `
`), ke += Se) : he = Ve(p.children);
        var De = {
          domNamespace: Fn(h, o.type),
          type: c,
          children: he,
          childIndex: 0,
          context: s,
    ...
    nt.renderToNodeStream = Pi, nt.renderToStaticMarkup = Di, nt.renderToStaticNodeStream = Ai, nt.renderToString = Ti, nt.version = E;
  }()), nt;
}
...
var bn = {
  ...
  style: void 0,
  attr: void 0
}, gn = _e.createContext && /* @__PURE__ */ _e.createContext(bn), Yi = ["attr", "size", "title"];
function $i(u, l) {
  if (u == null)
    return {};
  var f, E, C = Xi(u, l);
  if (Object.getOwnPropertySymbols) {
    ...
    for (E = 0; E < M.length; E++)
      f = M[E], l.indexOf(f) === -1 && {}.propertyIsEnumerable.call(u, f) && (C[f] = u[f]);
  }
  return C;
}
function Xi(u, l) {
...
function Gi(u, l, f) {
  return (l = Zi(l)) in u ? Object.defineProperty(u, l, { value: f, enumerable: !0, configurable: !0, writable: !0 }) : u[l] = f, u;
}
function Zi(u) {
  var l = Ki(u, "string");
...
function Ji(u) {
  var l = (f) => {
    var {
      ...
      size: C,
      title: M
    } = u, g = $i(u, Yi), I = C || f.size || "1em", j;
    return f.className && (j = f.className), u.className && (j = (j ? j + " " : "") + u.className), /* @__PURE__ */ _e.createElement("svg", Gt({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, f.attr, E, g, {
  ...
  ({ data: u, type: l, options: f = {}, height: E = 350, title: C }, M) => {
    ...
    const I = _t(null), j = Bi.renderToString(/* @__PURE__ */ Mt(eo, { size: 12 })), [w, P] = Li(!1), ee = _t(null), B = _t(null), Y = ln(() => l || (Array.isArray(u[0]) ? u.map((T) => fn(T)) : fn(u)), [u, l]), ne = ln(() => {
      ...
      if (Array.isArray(u[0]))
        ve = u.map((Le, be) => {
          const it = Array.isArray(l) && l[be] || (Array.isArray(Y) ? Y[be] : Y), xe = dn(it, Le);
          return {
            name: `Series ${be + 1}`,
            type: it,
            ...xe.series[0]
      ...
      const z = {
        ...
        plotOptions: {
          ...
          bubble: {
            minBubbleRadius: ((Xe = (X = f.plotOptions) == null ? void 0 : X.bubble) == null ? void 0 : Xe.minBubbleRadius) ?? 5,
    ...
    return un(() => {
    ...
    }, [ne]), un(() => (w && ee.current && (B.current = new cn(ee.current, {
      ...ne,
      chart: { ...ne.chart, toolbar: { show: !1 } }
      // Clean view for modal
    }), B.current.render()), () => {
      var T;
      (T = B.current) == null || T.destroy(), B.current = null;
    }), [w, ne]), Ni(M, () => ({
      zoomIn: () => {
        var T;
      ...
      toggleFullscreen: () => P(!w)
    })), /* @__PURE__ */ sn("div", { style: { height: E, width: "100%", position: "relative" }, children: [
      /* @__PURE__ */ Mt("div", { ref: g, style: { height: "100%", width: "100%" } }),
      w && /* @__PURE__ */ Mt("div", { style: {
        position: "fixed",
        inset: 0,
        ...
        zIndex: 9999
      }, children: /* @__PURE__ */ sn("div", { style: {
        width: "90%",
        maxWidth: "600px",
        ...
        /* @__PURE__ */ Mt("div", { ref: ee, style: { height: "100%", width: "100%" } })
      ] }) })
    ] });
  }
);
